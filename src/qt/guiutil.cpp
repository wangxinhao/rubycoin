...
{
    app.setStyleSheet("QWidget        { background: rgb(72,0,0); }"
                      "QFrame         { border: none; }"
                      ...
                      "QDoubleSpinBox { background: rgb(126,0,0); color: rgb(255,255,255); border-color: rgb(194,194,194); }"
                      "QLineEdit      { background: rgb(126,0,0); color: rgb(255,255,255); border-color: rgb(194,194,194); }"
                      "QTextEdit      { background: rgb(126,0,0); color: rgb(255,255,255); }"
                      "QPlainTextEdit { background: rgb(126,0,0); color: rgb(255,255,255); }"
