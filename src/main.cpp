...
uint256 hashGenesisBlock("0xffc7312b4ba9409b84a966d8666ee12c81dc2c3076d5e3a1e8f34892592b6e2e");
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Rubycoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x655ce1119db49b2f16310e2d199e48cf85fa999a9f2de67c18096165cb3700a1");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // block.GetHash = b280d6d2829e50aeb6862ced2c8c3de3f7360e0ee2e1521b2293b10ceba5693d
        ...
        if (fTestNet)
        {
            block.nTime    = 1393116636;
            block.nNonce   = 3808660;
        }
        ...
        //assert(block.hashMerkleRoot == uint256("0xb280d6d2829e50aeb6862ced2c8c3de3f7360e0ee2e1521b2293b10ceba5693d"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Rubycoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RubycoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RubycoinMiner : ProcessBlock, block not accepted");
    }
